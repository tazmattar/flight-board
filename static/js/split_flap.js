...
const SplitFlap = (() => {
    ...
    const INTER_MS      = 8;    // Gap between consecutive flaps on the same cell
    const STAGGER_MS    = 28;   // Delay offset per character position (wave effect)
    const MAX_STEPS     = 10;   // Cap on intermediate chars to keep animation snappy
